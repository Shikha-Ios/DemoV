...
@objc public protocol AYSwipeControllerDataSource {
...
open class AYSwipeController: UIViewController {
  ...
  public struct Constants {
    ...
    public static let navigationBarHeight: CGFloat = 0
  ...
  open weak var datasource: AYSwipeControllerDataSource?
  ...
  override open func loadView() {
    ...
    guard stackVC != nil else {
      print("Problem: AYSwipeController needs ViewController Data, please implement AYSwipeControllerDataSource")
      return
    }
    setupNavigationBar()
